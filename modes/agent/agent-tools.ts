...
export function createAgentTool(executor: ToolExecutor) {
  return {
    ...
    create_file: tool({
      ...
      inputSchema: z.object({
        path: z.string().describe("The relative path to the file to create."),
        content: z.string(),
      }),
    ...
    modify_file: tool({
      description:
        "Stage modification of an existing file (not written until the user approves).",
      inputSchema: z.object({
    ...
    delete_file: tool({
      description:
        "Stage deletion of an existing file (not deleted until the user approves).",
      inputSchema: z.object({
